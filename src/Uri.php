...
class Uri implements UriInterface, Stringable
{
    ...
    public function getAuthority()
    {
        ...
        $defaultPort = getservbyname($this->getScheme() ?: 'http', 'tcp');
        if ($this->getPort() != $defaultPort) {
    ...
    public function __construct(string $uri)
    {
        ...
        $this->query = new Query($parsed['query'] ?? '');
    ...
    public function __toString(): string
    {
        ...
        foreach (['scheme', 'host', 'port', 'user', 'path', 'fragment'] as $part) {
            $parts[$part] = $this->$part;
        }

        if ($this->password) {
            $parts['pass'] = $this->password;
        }

        $parts['query'] = $this->query->toString();
